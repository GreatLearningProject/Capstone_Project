...
@Component({
  selector: 'app-udipihotel',
  templateUrl: './udipihotel.component.html',
  styleUrls: ['./udipihotel.component.css']
})
export class UdipihotelComponent implements OnInit {
  hotel: string = 'UdipiHotel';
